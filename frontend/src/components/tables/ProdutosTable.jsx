...
function ProdutosTable() {
  ...
  const columns = [
    ...
    { field: 'nome', headerName: 'Nome', type: 'text', width: 400 },
    { field: 'categoria', headerName: 'Categoria', type: 'text', width: 200 },
    { field: 'estoque_atual', headerName: 'Estoque', width: 100 },
    { field: 'demanda_semanal', headerName: 'Demanda Semanal', width: 100 },
    { field: 'quantidade_indicada_ressuprimento', headerName: 'Ressuprimento', width: 100 },
    ...
    { field: 'lucro_unitario', headerName: 'Lucro Unitário', type: 'number', width: 100 },
    { field: 'quantidade_vendida', headerName: 'Quantidade Vendida', type: 'number', width: 150 },
    { field: 'lucro_total', headerName: 'Lucro Total', type: 'number', width: 100 },
    {
      field: 'Opções',
      headerName: 'Opções',
      width: 150,
